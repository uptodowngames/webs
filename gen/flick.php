...
#$proxies = Array("PROXY1:PORT1","PROXY2:PORT2");

#$chosenproxy = $proxies[rand(0, count($proxies) - 1)];
...
//curl_setopt($ch1, CURLOPT_PROXY, $cpsp);
...
//curl_setopt($ch2, CURLOPT_PROXY, $cpsp);
...
//curl_setopt($ch2, CURLOPT_PROXYUSERPWD, $cpup);
